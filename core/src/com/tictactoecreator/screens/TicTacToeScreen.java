...
import com.tictactoecreator.game.GamePlayHandler;
import com.tictactoecreator.game.GameSettings;
import com.tictactoecreator.game.Player;
import com.tictactoecreator.game.ShapeData;
import com.tictactoecreator.game.TicTacToeCell;
...
public class TicTacToeScreen extends BaseScreen {
    ...
    private void renderPieces(SpriteBatch batch, TextureAtlas atlas) {
        for (ShapeData data : gamePlayHandler.getCrosses()) {
            ...
            sprites[data.getBoardPositionX()][data.getBoardPositionY()].setColor(data.getColor());
    ...
    public void show() {
        ...
        backButton.addListener(new ClickListener() {
            public void clicked(InputEvent event, float x, float y){
                game.getAdsRequestHandler().showInterstitial();
    ...
    public boolean touchDown(int screenX, int screenY, int pointer, int button) {
        ...
        {
            if (GameOptions.getInstance().isFxEnabled())
                sound.play(1.0f);
        }
        return true;
    }
